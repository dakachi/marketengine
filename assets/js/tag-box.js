...
( function( $ ) {
    ...
    tagBox = {
        ...
        get : function( id ) {
            ...
            $.post( me_globals.ajaxurl, { 'action': 'get-tagcloud', 'tax': tax }, function( r, stat ) {
                if ( 0 === r || 'success' != stat ) {
                    return;
                }
        ...
        init : function() {
            ...
            $('input.newtag', ajaxtag).keyup(function(e){
                ...
                $(this).suggest(
                    me_globals.ajaxurl + '?action=ajax-tag-search&tax=' + tax,
