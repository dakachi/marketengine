<div class="marketengine-group-field">
	<div class="marketengine-input-field">
	    ...
	    <input <?php echo me_field_attribute($field['field_constraint']); ?> id="<?php echo $field['field_name'] ?>" type="number" placeholder="<?php echo $field['field_placeholder'] ?>" name="<?php echo $field['field_name'] ?>" value="<?php echo $value; ?>">
	</div>
</div>