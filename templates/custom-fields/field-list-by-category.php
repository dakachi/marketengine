			...
			<div class="me-cf-row-wrap">
				...
				<div class="me-cf-col-number">
					...
					<div class="me-cf-action">
						...
						<a class="me-cf-remove" href="<?php echo add_query_arg(array('action' => 'remove-from-category', '_wp_nonce' => wp_create_nonce('remove-from-category'), 'custom-field-id' => $field_id)); ?>" title="<?php _e('Remove from this category', 'enginethemes'); ?>" title="<?php _e('Remove from this category', 'enginethemes'); ?>"><i class="icon-me-trash"></i></a>
					</div>
				</div>
			</div>
		</div>
