...
<div class="me-contact-now">
	<form method="post">
		...
		<div class="me-contact">
			...
			<input type="submit" class="me-buy-now-btn" value="<?php echo me_option('contact-action', __("CONTACT NOW", "enginethemes"));  //_e("CONTACT NOW", "enginethemes"); ?>">
			<?php else : ?>
			<a href="<?php the_permalink(); ?>" class="me-buy-now-btn"><?php echo me_option('contact-action', __("CONTACT NOW", "enginethemes"));  //_e("CONTACT NOW", "enginethemes"); ?></a>
			<?php endif; ?>
		</div>
