...
<div class="me-buy-now">
	<form method="post">
		...
		<input type="submit" class="me-buy-now-btn" value="<?php echo me_option('purchasion-action') ?  me_option('purchasion-action') : __("BUY NOW", "enginethemes");?>">
		<?php else : ?>
		<a href="<?php the_permalink(); ?>" class="me-buy-now-btn"><?php echo me_option('purchasion-action') ?  me_option('purchasion-action') : __("BUY NOW", "enginethemes"); ?></a>
		<?php endif; ?>
