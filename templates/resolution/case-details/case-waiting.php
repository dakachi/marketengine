    ...
    <div class="me-row">
        <div class="me-col-md-6">
            <div class="me-disputed-close">
                ...
                <p>
                    <?php _e("The seller has requested to close this dispute. In case you are not satisfied with the proposal, you can continue negotiating or escalate to the Admin.", "enginethemes"); ?>
                </p>
            </div>
        </div>
