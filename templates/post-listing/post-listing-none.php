<div class="me-post-listing-none">
	...
	<p><?php printf(__("You should <a href='%s'>register</a>,","enginethemes"), me_get_auth_url('register') ); printf(__(" <a href='%s'>login</a> or active your account before post a listing","enginethemes"), me_get_page_permalink('user_account') ); ?> </p>
</div>