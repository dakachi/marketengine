        ...
        'general' => array(
            ...
            'template'     => array(
                ...
                'commission_fee'          => array(
                    ...
                    'description' => __("Set up commission fee as percentage (%) of an order price. Seller will be charged for the commission.", "enginethemes"),
            ...
            'template' => array(
                'purchase'               => array(
                    ...
                    'template'           => array(
                        'purchase-title'         => array(
                            ...
                            'description' => __('The labels would be shown ra allow user to filter, for example: "Selling"', "enginethemes"),
                            'slug'        => 'purchase-title',
                            'type'        => 'textbox',
                            'name'        => 'purchase-title',
                        ),
                        'purchase-action'         => array(
                            ...
                            'description' => __("Labels for behaviors that people can do", "enginethemes"),
                ...
                'contact'               => array(
                    ...
                    'template'           => array(
                        'purchase-title'         => array(
                            'label'       => __("Title", "enginethemes"),
                            'description' => __('The labels would be shown ra allow user to filter, for example:  "Offering"', "enginethemes"),
                            'slug'        => 'contact-title',
                            'type'        => 'textbox',
                            'name'        => 'contact-title',
                        ),
